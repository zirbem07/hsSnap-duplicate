 app.factory('ID', function() {
    return {
      ...
      //Production
        ...
        ShareVault: 'f0cbcad8-b18a-4553-a94e-4c956ee0ff65',
        SharePatientSchema: 'b18e9608-a4e1-4aef-84be-3d231b035ae3',

        PatientLogVault: 'd59f5dd1-1d34-4f4a-8b6a-c0b81849987b',

        EmailLink: 'https://healthconnection.io/hcMailgun/setPasswordEmail.php',
        ResetEmailLink: 'https://healthconnection.io/hcMailgun/resetPasswordEmail.php',
        SupportLink: 'https://healthconnection.io/hcMailgun/supportEmail.php',
